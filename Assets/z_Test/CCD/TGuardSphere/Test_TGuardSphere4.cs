...
namespace Test_TGuardSphere4
{
    ...
    public class Test_TGuardSphere4 : MonoBehaviour
    {
        ...
        public SegementCCD _movTgs = new SegementCCD();
        ...
        public bool __rotate_0 = false;
        public bool __rotate_1 = false;
        public bool __prev_0_Frame = false;
        public bool __next_0_Frame = false;
        ...
        public void Update_FrameStep()
        {
            ...
            if (true == _tgs_A._init)
            {
                ...
                //각도후진 시험 
                if (true == __prev_0_Frame)
                {
                    __prev_0_Frame = false;
                    ...
                    _tgs_A._T0_root.rotation *= Quaternion.AngleAxis(__angle, -ConstV.v3_up);
                }

                ////각도전진 시험
                if (true == __next_0_Frame)
                {
                    __next_0_Frame = false;
                    Vector3 ori = _tgs_A._T0_root.position;
                    Vector3 start = _tgs_A._T0_root_end.position;
                    Vector3 end = _tgs_A._Tctl_root_end.position;
                    Vector3 up_angle = Vector3.Cross(start - ori, end - ori);
                ...
                if (true == __rotate_1)
                {
                    _tgs_B._T0_root.rotation *= Quaternion.AngleAxis(__angle, ConstV.v3_up);
                }
                ...
                //if (true == __nextFrame)
                {
                    ...
                    if (true == contact)
                    {
                        ...
                        _tgs_A._T0_root.rotation = _movTgs._localRota_A * _tgs_A._T0_root.rotation; //실제적용 
                        _tgs_B._T0_root.rotation = _movTgs._localRota_B * _tgs_B._T0_root.rotation; //실제적용 

                        //이동값 선분에 적용
                        _tgs_A._T0_root.position += _movTgs._dir_move_A;
                        _tgs_B._T0_root.position += _movTgs._dir_move_B;
        ...
        private void Update_RealTime_2()
        {
            ...
            if (true == _tgs_A._init)
            {
                ...
                if (true == contact)
                {
                    ...
                    _tgs_A._T0_root.rotation = _movTgs._localRota_A * _tgs_A._Tctl_root.rotation; //실제적용 
                    _tgs_B._T0_root.rotation = _movTgs._localRota_B * _tgs_B._Tctl_root.rotation; //실제적용 
        ...
        private void Update_StopTime()
        {
            ...
            if (true == _tgs_A._init)
            {
                ...
                if (true == contact)
                {
                    ...
                    _tgs_A._T1_root.rotation = _movTgs._localRota_A * _tgs_A._Tctl_root.rotation; //실제적용 
                    _tgs_B._T1_root.rotation = _movTgs._localRota_B * _tgs_B._Tctl_root.rotation; //실제적용 

                    //이동값 선분에 적용
                    _tgs_A._T1_root.position += _movTgs._dir_move_A;
                    _tgs_B._T1_root.position += _movTgs._dir_move_B;
